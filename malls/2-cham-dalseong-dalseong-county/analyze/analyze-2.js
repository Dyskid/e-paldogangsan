...
async function analyzeNaverSmartStore() {
    ...
    try {
        ...
        if ((response === null || response === void 0 ? void 0 : response.status()) === 429) {
            ...
            console.log('Retry response status:', response === null || response === void 0 ? void 0 : response.status());
        }
        ...
        fs.writeFileSync(path.join(__dirname, 'requirements', `main-page-rendered-${timestamp}.html`), mainPageHtml);
        ...
        const isErrorPage = await page.evaluate(() => {
            ...
            const errorIndicators = [
                ...
                document.querySelector('[class*="Error"]'),
                (_a = document.body.textContent) === null || _a === void 0 ? void 0 : _a.includes('접속이 불가'),
                (_b = document.body.textContent) === null || _b === void 0 ? void 0 : _b.includes('시스템오류'),
                (_c = document.body.textContent) === null || _c === void 0 ? void 0 : _c.includes('페이지를 찾을 수 없습니다')
            ];
        ...
        if (isErrorPage) {
                        ...
                        elements.forEach((el, index) => {
                            ...
                            if (anchor.href && anchor.href.includes('/category/')) {
                                foundCategories.push({
                                    name: ((_a = anchor.textContent) === null || _a === void 0 ? void 0 : _a.trim()) || '',
                                    url: anchor.href,
                                    id: ((_b = anchor.href.match(/category\/([^?]+)/)) === null || _b === void 0 ? void 0 : _b[1]) || `cat${index}`
                                });
                            }
                        });
                        break;
            ...
            try {
                ...
                fs.writeFileSync(path.join(__dirname, 'requirements', `products-page-rendered-${timestamp}.html`), productsPageHtml);
                        ...
                        if (containers.length > 0) {
                            ...
                            containers.forEach((container, index) => {
                                ...
                                for (const nameSel of productSelectors.name) {
                                    ...
                                    if (nameEl === null || nameEl === void 0 ? void 0 : nameEl.textContent) {
                                ...
                                for (const priceSel of productSelectors.price) {
                                    ...
                                    if (priceEl === null || priceEl === void 0 ? void 0 : priceEl.textContent) {
                                ...
                                for (const imgSel of productSelectors.image) {
                                    ...
                                    if (imgEl === null || imgEl === void 0 ? void 0 : imgEl.src) {
                ...
                const totalProductsText = await page.evaluate(() => {
                    ...
                    for (let i = 0; i < allSpans.length; i++) {
                        ...
                        if ((_a = span.textContent) === null || _a === void 0 ? void 0 : _a.includes('개')) {
