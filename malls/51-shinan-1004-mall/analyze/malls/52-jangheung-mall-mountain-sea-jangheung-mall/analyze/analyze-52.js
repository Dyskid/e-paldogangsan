...
function generateAnalysisFile() {
    var analysis = analyzeJangheungMall();
    var outputPath = path.join(__dirname, 'analysis-52.json');
    fs.writeFileSync(outputPath, JSON.stringify(analysis, null, 2), 'utf-8');
    console.log("Analysis file generated at: ".concat(outputPath));
}
// Run the analysis
