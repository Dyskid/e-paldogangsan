...
class Mallyeongdeok-marketScraper {
  private baseUrl = 'https://ydmall.cyso.co.kr/';
  private mallId = yeongdeok-market;
  private mallName = 'yeongdeok-market';
...
// Run the scraper
const scraper = new Mallyeongdeok-marketScraper();
