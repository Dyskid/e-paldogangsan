...
async function analyzeKkimchiStructure(): Promise<void> {
  ...
  try {
    ...
    writeFileSync('./kkimchi-homepage.html', response.data);
    ...
    writeFileSync('./kkimchi-analysis.json', JSON.stringify(analysis, null, 2));
    ...
    writeFileSync('./kkimchi-analysis-error.json', JSON.stringify(errorInfo, null, 2));
  }
}
