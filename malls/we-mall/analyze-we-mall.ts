...
async function analyzeWemallStructure(): Promise<void> {
  ...
  try {
    ...
    writeFileSync('./wemall-homepage.html', response.data);
    ...
    writeFileSync('./wemall-analysis.json', JSON.stringify(analysis, null, 2));
    ...
    writeFileSync('./wemall-analysis-error.json', JSON.stringify(errorInfo, null, 2));
  }
}
