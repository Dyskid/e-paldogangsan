...
class Mall93Scraper {
  private baseUrl = 'https://mall.ejeju.net/main/index.do';
  private mallId = 93;
  private mallName = 'e-jeju-mall';
  ...
  private async getCategories() {
    try {
      ...
      const categorySelectors = ['.product'];
  ...
  private extractProducts($: cheerio.CheerioAPI, categoryName: string): number {
    let productCount = 0;
    const productSelectors = ['.product', '.item', '.goods'];
...
// Run the scraper
const scraper = new Mall93Scraper();
