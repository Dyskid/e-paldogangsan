...
function analyzeReport(mallId, mallDir) {
    // Find report path
...
function main() {
    ...
    fs.writeFileSync('/mnt/c/Users/johndoe/Desktop/e-paldogangsan/scraper-schema-analysis-detailed.json', JSON.stringify(detailedResults, null, 2));
    console.log('\n## Files Generated\n');
