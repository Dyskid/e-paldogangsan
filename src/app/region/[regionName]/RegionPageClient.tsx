...
export default function RegionPageClient({ region, malls, regions, categories }: RegionPageClientProps) {
              ...
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{malls.length}개</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">추천 쇼핑몰</span>
                    <span className="font-medium">
                      {malls.filter(m => m.featured).length}개
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">신규 쇼핑몰</span>
                    <span className="font-medium">
                      {malls.filter(m => m.isNew).length}개
                    </span>
                  </div>
                </div>
              </div>
