...
const malls: Mall[] = [
  ...
  { id: 'mall_22', name: '양양몰', url: 'https://yangyang-mall.com/', region: '강원도' },
  { id: 'mall_23', name: '영월몰', url: 'https://yeongwol-mall.com/', region: '강원도' },
  { id: 'mall_24', name: '인제몰', url: 'https://inje-mall.com/', region: '강원도' },
  { id: 'mall_25', name: '철원몰', url: 'https://cheorwon-mall.com/', region: '강원도' },
  { id: 'mall_26', name: '정선몰', url: 'https://jeongseon-mall.com/', region: '강원도' },
  { id: 'mall_27', name: '태백몰', url: 'https://taebaek-mall.com/', region: '강원도' },
  { id: 'mall_28', name: '횡성몰', url: 'https://hoengseong-mall.com/', region: '강원도' },
  { id: 'mall_29', name: '춘천몰', url: 'https://gwch-mall.com/', region: '강원도' },
  { id: 'mall_30', name: '홍천몰', url: 'https://hongcheon-mall.com/', region: '강원도' },
  { id: 'mall_31', name: '평창몰', url: 'https://gwpc-mall.com/', region: '강원도' },
  
  // 충청북도
  { id: 'mall_32', name: '제천로컬푸드', url: 'https://www.jclocal.co.kr', region: '충청북도' },
  { id: 'mall_33', name: '음성장터', url: 'https://www.esjang.go.kr/', region: '충청북도' },
  { id: 'mall_34', name: '진천몰', url: 'https://jcmall.net/', region: '충청북도' },
  { id: 'mall_35', name: '괴산장터', url: 'https://www.gsjangter.go.kr/', region: '충청북도' },
  
  // 충청남도
  { id: 'mall_36', name: '농사랑', url: 'https://nongsarang.co.kr/', region: '충청남도' },
  { id: 'mall_37', name: '당진팜', url: 'https://dangjinfarm.com/', region: '충청남도' },
  { id: 'mall_38', name: 'e홍성장터', url: 'https://ehongseong.com/', region: '충청남도' },
  { id: 'mall_39', name: '서산뜨레', url: 'https://seosanttre.com', region: '충청남도' },
  
  // 전라북도
  { id: 'mall_40', name: '부안 텃밭할매', url: 'https://www.xn--9z2bv5bx25anyd.kr/', region: '전라북도' },
  { id: 'mall_41', name: '단풍미인 (정읍)', url: 'https://www.danpoongmall.kr/', region: '전라북도' },
  { id: 'mall_42', name: '지평선몰(김제)', url: 'https://www.jpsmall.com/', region: '전라북도' },
  { id: 'mall_43', name: '전북생생장터', url: 'https://freshjb.com/', region: '전라북도' },
  { id: 'mall_44', name: '익산몰', url: 'https://iksanmall.com/', region: '전라북도' },
  { id: 'mall_45', name: '진안고원몰', url: 'https://xn--299az5xoii3qb66f.com/', region: '전라북도' },
  { id: 'mall_46', name: '장수몰', url: 'https://www.장수몰.com/', region: '전라북도' },
  { id: 'mall_47', name: '고창마켓', url: 'https://noblegochang.com/', region: '전라북도' },
