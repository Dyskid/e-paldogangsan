...
async function testChuncheonProduct(): Promise<void> {
  try {
    console.log('🧪 Testing Chuncheon Mall product page structure...');
    
    // Test an actual product URL
    const testUrl = 'https://gwch-mall.com/goods/view?no=101418';
    ...
    const alternativeUrls = [
      'https://gwch-mall.com/goods/view?no=28181',
      'https://gwch-mall.com/goods/view?no=44105',
      'https://gwch-mall.com/goods/view?no=4490'
    ];
