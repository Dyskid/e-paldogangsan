...
async function testSamcheokProduct() {
  console.log('🧪 Testing Samcheok Mall product page structure...');
  ...
  try {
    ...
    for (let i = 0; i < testUrls.length; i++) {
      ...
      try {
        ...
        const outputPath = path.join(__dirname, 'output', `samcheok-product-${i + 1}.html`);
