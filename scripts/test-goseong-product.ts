...
async function testGoseongProduct() {
  console.log('🧪 Testing Goseong Mall product page structure...');
  ...
  try {
    ...
    for (let i = 0; i < testUrls.length; i++) {
      ...
      try {
        ...
        const outputPath = path.join(__dirname, 'output', `goseong-product-${i + 1}.html`);
