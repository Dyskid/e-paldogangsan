...
async function analyzeSeosanttreStructure() {
  ...
  try {
    ...
    fs.writeFileSync('./scripts/output/seosanttre-homepage.html', response.data);
    ...
    fs.writeFileSync('./scripts/output/seosanttre-structure-analysis.json', JSON.stringify(analysis, null, 2));
