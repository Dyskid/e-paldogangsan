...
async function testHoengseongProduct(): Promise<void> {
  try {
    console.log('🧪 Testing Hoengseong Mall product page structure...');
    
    // Test an actual product URL
    const testUrl = 'https://hoengseong-mall.com/goods/view?no=106501';
    ...
    const alternativeUrls = [
      'https://hoengseong-mall.com/goods/view?no=106875',
      'https://hoengseong-mall.com/goods/view?no=105833',
      'https://hoengseong-mall.com/goods/view?no=43633'
    ];
