...
/**
 * Mangotree platform scraper (S009)
 * Scraper for Mangotree platform sites
 */
async function scrapeMangotree(mall) {
  ...
  try {
    ...
    // Mangotree platform specific selectors
    const selectors = [
      '.mangotree-product li',
      '.product-list li',
      '.goods-list li',
      '.item-list li',
      '.product-item',
