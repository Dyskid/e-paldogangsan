...
async function analyzeHwasunfarmStructure() {
  ...
  try {
    ...
    writeFileSync('./scripts/output/hwasunfarm-homepage.html', response.data);
    ...
    // Save analysis
    writeFileSync('./scripts/output/hwasunfarm-structure-analysis.json', JSON.stringify(analysis, null, 2));
