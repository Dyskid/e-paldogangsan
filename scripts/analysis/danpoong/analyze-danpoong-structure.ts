...
async function analyzeDanpoongStructure() {
  ...
  try {
    ...
    fs.writeFileSync('./scripts/output/danpoong-homepage.html', response.data);
    ...
    fs.writeFileSync('./scripts/output/danpoong-structure-analysis.json', JSON.stringify(analysis, null, 2));
