...
async function testTaebaekProduct(): Promise<void> {
  try {
    console.log('🧪 Testing Taebaek Mall product page structure...');
    
    // Test an actual product URL
    const testUrl = 'https://taebaek-mall.com/goods/view?no=42992';
    ...
    const alternativeUrls = [
      'https://taebaek-mall.com/goods/view?no=37990',
      'https://taebaek-mall.com/goods/view?no=31541',
      'https://taebaek-mall.com/goods/view?no=38327'
    ];
