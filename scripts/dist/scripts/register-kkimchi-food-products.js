...
function parseKimchiPrice(priceString) {
    if (!priceString)
        return { price: 0 };
...
function registerKKimchiFoodProducts() {
    ...
    try {
        ...
        const scrapedData = (0, fs_1.readFileSync)('./scripts/output/kkimchi-products.json', 'utf-8');
        ...
        Array.from(uniqueProducts.values()).forEach(scraped => {
            ...
            if (priceInfo.price > 0)
                productsWithPrices++;
            if (priceInfo.originalPrice && priceInfo.originalPrice > priceInfo.price)
        ...
        (0, fs_1.writeFileSync)('./src/data/products.json', JSON.stringify(nonKKimchiProducts, null, 2));
        // Generate summary
        const summary = {
        ...
        (0, fs_1.writeFileSync)('./scripts/output/kkimchi-food-registration-summary.json', JSON.stringify(summary, null, 2));
        ...
        (0, fs_1.writeFileSync)('./scripts/output/kkimchi-food-registration-error.json', JSON.stringify(errorInfo, null, 2));
    }
}
