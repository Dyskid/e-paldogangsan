...
function verifyWemallFoodRegistration() {
    ...
    try {
        ...
        // Save report
        (0, fs_1.writeFileSync)('./scripts/output/wemall-food-verification-final.json', JSON.stringify(report, null, 2));
        // Print summary
        ...
        (0, fs_1.writeFileSync)('./scripts/output/wemall-food-verification-error.json', JSON.stringify(errorInfo, null, 2));
        throw error;
    }
}
// Run verification
