...
async function testCheorwonProduct(): Promise<void> {
  try {
    console.log('🧪 Testing Cheorwon Mall product page structure...');
    
    // Test an actual product URL
    const testUrl = 'https://cheorwon-mall.com/goods/view?no=108857';
    ...
    const alternativeUrls = [
      'https://cheorwon-mall.com/goods/view?no=1',
      'https://cheorwon-mall.com/goods/view?no=2',
      'https://cheorwon-mall.com/goods/view?no=5'
    ];
